...
*/
extern macho_command_t* macho_command_create(void);
extern macho_command_t* macho_command_load(unsigned char* data, unsigned int offset);

extern void macho_command_debug(macho_command_t* command);
extern void macho_command_free(macho_command_t* command);

/*
 * Mach-O Command Info Functions
 */
extern macho_command_info_t* macho_command_info_create(void);
extern macho_command_info_t* macho_command_info_load(unsigned char* data, unsigned int offset);
extern void macho_command_info_debug(macho_command_info_t* info);
extern void macho_command_info_free(macho_command_info_t* info);
